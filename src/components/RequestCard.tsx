      ...
      <Dialog>
        <DialogTrigger asChild>
          <div className={cn("p-0 cursor-pointer hover:bg-white/[0.02] transition-colors flex-1", variant === 'list' && "flex flex-col md:flex-row items-stretch")}>
            ...
            <div className={cn("p-6 flex-1 flex flex-col justify-center", variant === 'list' && "grid grid-cols-1 md:grid-cols-12 gap-8 items-center") || "p-6 flex-1 flex flex-col justify-center space-y-4"}>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent className="glass-card border-white/10 p-8 rounded-[32px]">
                        ...
                        <AlertDialogFooter className="gap-3">
                          ...
                          <AlertDialogAction onClick={handleDelete} className="bg-rose-600 hover:bg-rose-500 text-white<dyad-write path="src/components/RequestCard.tsx" description="Fixing the JSX namespace syntax error and ensuring the request detail dialog is fully scrollable.">
"use client";
